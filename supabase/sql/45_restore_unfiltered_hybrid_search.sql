-- =========================================================================
-- Migration: 45_restore_unfiltered_hybrid_search.sql
-- Goal: Overwrite hybrid_search to completely remove the rigid >= 0.50 
--       cosines similarity threshold, so that the Reciprocal Rank Fusion (RRF60)
--       algorithm can naturally rank the entire continuum of results.
-- =========================================================================
