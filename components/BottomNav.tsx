      ...
      <div className="relative w-full h-full max-w-lg mx-auto">
        ...
        <div className="absolute left-1/2 top-0 -translate-x-1/2 -translate-y-1/2 pointer-events-auto">
            <button
                ...
                className="w-16 h-16 bg-lime rounded-full flex items-center justify-center text-[var(--text-on-primary)] shadow-lg shadow-[0_0_15px_rgba(216,240,102,0.3)] hover:scale-110 transition-transform duration-300 ring-4 ring-[var(--bg-card)]"
